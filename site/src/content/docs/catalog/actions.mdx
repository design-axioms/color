...
<Diagram className="surface-card bordered" style={{ padding: '2rem', display: 'flex', gap: '1rem' }}>
  <button class="surface-action focus-ring" style={{ padding: '0.5rem 1rem', border: 'none', borderRadius: '4px' }}>Focus Me</button>
  <input class="surface-workspace focus-ring bordered" placeholder="Focus Me" style={{ padding: '0.5rem', borderRadius: '4px' }} />
</Diagram>
