...
<Diagram>
  <div class="docs-grid-comparison">
    ...
    <div class="docs-swatch-grid">
      <div class="docs-swatch" style="background: oklch(0.1 0.15 278);" title="L=0.1, H=278 (+18°)"></div>
      <div class="docs-swatch" style="background: oklch(0.3 0.15 314);" title="L=0.3, H=314 (+54°)"></div>
      <div class="docs-swatch" style="background: oklch(0.5 0.15 350);" title="L=0.5, H=350 (+90°)"></div>
      <div class="docs-swatch" style="background: oklch(0.7 0.15 26);" title="L=0.7, H=26 (+126°)"></div>
      <div class="docs-swatch" style="background: oklch(0.9 0.15 62);" title="L=0.9, H=62 (+162°)"></div>
    </div>

    {/* Bezier Row */}
    <div class="text-subtle text-right">Bezier</div>
    <div class="docs-swatch-grid">
      <div class="docs-swatch" style="background: oklch(0.1 0.15 265);" title="L=0.1, H=265 (+5°)"></div>
      <div class="docs-swatch" style="background: oklch(0.3 0.15 299);" title="L=0.3, H=299 (+39°)"></div>
      <div class="docs-swatch" style="background: oklch(0.5 0.15 350);" title="L=0.5, H=350 (+90°)"></div>
      <div class="docs-swatch" style="background: oklch(0.7 0.15 41);" title="L=0.7, H=41 (+141°)"></div>
      <div class="docs-swatch" style="background: oklch(0.9 0.15 75);" title="L=0.9, H=75 (+175°)"></div>
    </div>
