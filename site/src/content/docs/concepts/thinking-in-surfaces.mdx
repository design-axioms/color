...
<Diagram>
  <div class="mb-4 text-sm text-text-subtle">
    Use the global Token Inspector{" "}
    <svg
...
<div class="docs-grid not-content my-6">
  ...
  >
    <div style="margin-top: 1rem; display: flex; flex-direction: column; gap: 0.75rem;">
      <div
        class="text-subtle"
        style="height: 0.5rem; width: 33%; background-color: currentColor; opacity: 0.2; border-radius: 0.125rem;"
      ></div>
      <div
        class="text-subtle"
        style="height: 0.5rem; width: 75%; background-color: currentColor; opacity: 0.2; border-radius: 0.125rem;"
      ></div>
      <div
        class="text-subtle"
        style="height: 0.5rem; width: 50%; background-color: currentColor; opacity: 0.2; border-radius: 0.125rem;"
      ></div>
    </div>
  </SurfacePreview>
  <SurfacePreview
  ...
  >
    <div style="margin-top: 1rem; display: flex; flex-direction: column; gap: 0.75rem;">
      <div
        class="text-brand"
        style="height: 0.5rem; width: 33%; background-color: currentColor; opacity: 0.4; border-radius: 0.125rem;"
      ></div>
      <div
        class="text-brand"
        style="height: 0.5rem; width: 75%; background-color: currentColor; opacity: 0.3; border-radius: 0.125rem;"
      ></div>
    </div>
  </SurfacePreview>
</div>
