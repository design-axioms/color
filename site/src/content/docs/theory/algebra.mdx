...
<Aside type="note" title="In Plain English">
  - **Atmosphere ($\alpha$)**: The "Weather" of the room. - **Voice ($\nu$)**:
  The "Script". - **Time ($\tau$)**: The "Clock". - **Gain ($\gamma$)**: The
  "Volume Knob". (Turn it up for High Contrast). - **System ($\sigma$)**: The
  "Physics Engine". (Rich vs. X-Ray).
</Aside>
...
<Aside type="note" title="In Plain English">
  - **The Sine Wave**: Yellows can be brighter than Blues. - **The Bicone**: As
  you get closer to White or Black, the allowed chroma drops linearly to zero. -
  **The Tunnel**: During the twilight transition, we dim the colors to ensure
  safety.
</Aside>
