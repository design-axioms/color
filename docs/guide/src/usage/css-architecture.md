...
To support this, you can generate a "High Contrast" variant of your theme (e.g., targeting Lc 90 for body text) and wrap it in a media query:
...
/* High Contrast Override (Optional) */
@media (prefers-contrast: more) {
  /* Generated by running the Builder with stricter targets */
  .surface-card {
    --text-subtle-token: ...; /* Darker text */
    --border-dec-token: ...; /* Darker borders */
  }
}
```

This allows you to maintain your brand identity while satisfying users who need sharper edges and deeper blacks.
