...
This document details how the color system works in the browser.
...
- **High Contrast:** The solver can generate a parallel set of tokens with stricter contrast targets.
